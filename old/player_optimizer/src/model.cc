...
void Model::createConstraints()
{
    ...
    for (set<string>::iterator it = teams.begin(); it != teams.end(); ++it)
    {
        ...
        string sub_player_vars = " - " + player_vars[0];
        ...
        for (int j = 1; j < num_players; ++j)
        {
            ...
            sub_player_vars += " - " + player_vars[j];
            // this->constraints_ += team_vars[i] + " - (" + player_vars[j] + ") >= 0" + "\n";
        ...
        // this->constraints_ += "- (" +team_vars[i] + ")" + sum_player_vars  + " >= 0 " + "\n";
        // this->constraints_ += team_vars[i] + "- (" + sum_player_vars  + ") <= 0 " + "\n";
